...
const PasswordShow = () => {
  ...
  const roles = [
    ...
    },
    {
      ...
      roleType: "ram",
      description: "Apni franchise ke orders, Products ko manage karta hai. Sales aur reports dekh sakta hai.",
      username: "test88@gmail.com",
      password: "12345678",
      icon: <Store size={32} />,
    ...
    },
    {
      ...
      roleType: "user",
      description: "Products order karta hai, offers use karta hai aur order history dekh sakta hai.",
